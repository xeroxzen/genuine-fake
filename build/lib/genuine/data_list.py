...
allergens = [
	'Balsam of Peru', 'Egg', 'Fish', 'Fruit' 'Garlic', 'Hot pepper', 'Oats', 'Maize', 'Milk', 'Poultry Meat', 'Red Meat', 'Rice', 'Sesame', 'Shellfish', 'Soy', 'Sulfites', 'Tartrazine', 'Tree Nut', 'Wheat', 'Tetracycline', 'Dilantin', 'Tegretol', 'Penicillin', 'Cephalosporins', 'Sulfonamides', 'anti-inflammatories', 'intravenous contrast dye', 'local anaesthetics', 'Pollen', 'cat', 'dog', 'insect sting', 'perfume', 'mold', 'cosmetics', 'semen', 'latex', 'water', 'house dust mite', 'Nickel', 'Gold', 'Chromium', 'cobalt', 'formaldehyde', 'Photographic developers', 'Fungicide'
]

places = [
	'New Luveve, Bulawayo', 'Pumula', 'Mahatshula', 'Nkulumane', 'Sunninghill', 'Hillside', 'Hillcrest', 'Burnside', 'Douglasdale', 'Entumbane', 'Northend', 'Harrisvale', 'Mbundane', 'Masasa', 'Borrowdale Brook', 'Mbare', 'Mt Pleasant', 'Makokoba', 'Mzilikazi', 'Lobengula', 'Malindela', 'Tshabalala', 'Old Luveve', 'Gwabalanda', 'Emganwini', 'Nketa', 'Trenance', 'Emakhandeni', 'Cowdray Park', 'Matshe-umhlophe', 'Njube', 'Magwegwe', 'Msasa'
]
